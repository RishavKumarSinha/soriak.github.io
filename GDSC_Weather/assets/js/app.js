            ...
            fetchData(url.geo(searchField.value), function(locations){
                ...
                for(const {name, lat, lon, country, state} of locations){
                    ...
                    <i class="material-icons">location_on</i>
                        ...
                        <a href="#weather?lat=${lat}&lon=${lon}" class="item-link leading-icon has-state" aria-label="${name} weather" data-search-toggler></a>
                    `;
...
const cointainer = document.querySelector("[data-container]");
...
export const updateWeather = function(lat , lon) {
    ...
    cointainer.style.overflowY = "hidden";
    cointainer.classList.remove("fade-in");
    ...
    if(window.length.hash == "#/current-location") {
        ...
        const{
            ...
            fetchData(url.airPollution(lat, lon), function(airPollution){
                ...
                <div class="card card-sm highlight-card one">
                    ...
                    <span class="badge aqi-${aqi} label-${aqi}" tittle="${module.aqiText[aqi].message}">
            ...
            fetchData(url.forecast(lat,lon), function (forecast){
                ...
                for(const [index, data] of forecastList.entries()){
                    ...
                    <div class="card card-sm slider-card">
                                ...
                                <img src="./assets/images/weather_icons/${icon}" width="48" height="48" loading="lazy" alt="${description}" class="weather-icon" title="${description}">
